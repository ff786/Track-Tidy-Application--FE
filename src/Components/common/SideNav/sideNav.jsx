    ...
    return (
        <>
            ...
            <div className={`sticky z-50 ${isExpanded ? 'expanded' : 'collapsed'} items-start`}>
                <nav ref={sidebarRef}
                     className={`flex flex-col fixed top-0 left-0 h-full bg-[#069385] transition-all duration-500 ease-in-out p-4 shadow-md z-5 ${
                         isExpanded ? 'w-80' : 'w-20'
                     } ${isSidebarLocked ? 'locked' : ''}`}>
                    <div className="min-h-full bg-[#069385] relative flex flex-col items-start">
                        <div className="flex gap-1 items-start mt-3 w-full">
                            <span className={`text-3xl text-[#000] font-bold transition-all duration-300 ${isExpanded ? 'opacity-100' : 'opacity-0 pointer-events-none'} text-start items-start justify-start`}>
                                Track Tidy
                            </span>
                            <i className={`bx ${isSidebarLocked ? 'bx-lock-alt' : 'bx-lock-open-alt'} p-2 text-2xl text-black cursor-pointer transition-all duration-300 ${isExpanded ? '' : 'opacity-0 pointer-events-none'}`}
                        ...
                        <div><p className={`text-black text-m text-left mt-2 mb-3 ${isExpanded ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
                        ...
                        <div className="block mb-auto overflow-y-auto h-full max-h-screen w-full">
                            <div className="menu_items w-full">
                                <ul className="list-none p-0 w-full">
                                    <div className={`relative cursor-pointer h-12 text-black flex flex-row items-start w-full transition-all duration-300 ${isClicked ? 'bg-black rounded-lg' : 'bg-white rounded-lg'}`}
                                    ...
                                    {activeDropdown === 'dashboard' && (
                                        <ul className="list-none p-0" style={{ display: isExpanded ? 'block' : 'none' }}>
                                            <li className="py-2 px-2 w-full">
                                                <a href="#" className="no-underline rounded-lg mb-0.5 text-white flex items-start hover:bg-[#57c2b7] p-2">
                                                    <i className="bx bx-home-alt h-12 min-w-14 flex text-xl items-start"></i>
                                                    <span className="ml-2 text-left">Home</span>
                                                </a>
                                            </li>
                                            <li className="py-2 px-2 w-full">
                                                <a href="/view-in" className="no-underline rounded-lg mb-0.5 text-white flex items-start hover:bg-[#57c2b7] p-2">
                                                    <i className="bx bx-user h-12 min-w-14 flex text-xl items-start"></i>
                                                    <span className="ml-2 text-left">My Inventory</span>
                                                </a>
                                            </li>
                                            <li className="py-2 px-2 w-full">
                                                <a href="/user-services" className="no-underline rounded-lg mb-0.5 text-white flex items-start hover:bg-[#57c2b7] p-2">
                                ...
                                <ul className="list-none p-0">
                                    <div className="relative cursor-pointer h-12 text-black flex flex-row justify-between items-center bg-white rounded-lg"
                                    ...
                                    {activeDropdown === 'dashboard2' && (
                                        <ul className="list-none p-0" style={{ display: isExpanded ? 'block' : 'none' }}>
                                            <li className="py-2 px-5">
                                                <a href="#" className="no-underline rounded-lg mb-0.5 text-white flex items-center hover:bg-[#57c2b7]">
