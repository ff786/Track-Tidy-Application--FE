...
const TrackTidyHomePage = () => {
    ...
    const scaleUp = {
        hidden: {scale: 0.95, opacity: 0}, visible: {scale: 1, opacity: 1, transition: {duration: 0.5}}
    };
    ...
    useEffect(() => {
        if (containerRef.current) {
            ...
            containerRef.current.scrollTo({
                left: currentIndex * itemWidth, behavior: 'smooth'
            });
        }
                ...
                <span className="block text-sm font-semibold uppercase tracking-wide text-green-800">
                  ...
                  <span className="block text-green-800">Made Simple</span>
                            ...
                            <div className="mt-8 sm:max-w-lg sm:mx-auto sm:text-center lg:text-left lg:mx-0">
                                <form onSubmit={handleSubmit} className="mt-3 sm:flex">
                                    <motion.input
                                        ...
                                        className="mt-3 px-4 py-3 placeholder-gray-400 text-gray-900 rounded-md w-full border border-gray-300 focus:outline-none focus:ring-2 focus:ring-green-600 focus:border-transparent"
                                    ...
                                    <motion.button
                                        ...
                                        whileTap={{scale: 0.97}}
                                        type="submit"
                                        className="mt-3 w-auto px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-green-800 shadow-sm hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-600 sm:mt-0 sm:ml-3 sm:flex-shrink-0"
                                    >
                                        Get Started Free
                                    </motion.button>
                                </form>
                        ...
                        <motion.div
                            ...
                            className="mt-10 relative max-w-full sm:max-w-screen-xl sm:mx-auto lg:mt-0 lg:max-w-none lg:mx-0 lg:col-span-6 lg:flex lg:items-center"
                        >
                            <div
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <motion.div variants={itemVariants} className="text-center">
                        ...
                        <p className="max-w-xl mt-5 mx-auto text-xl text-gray-500">
                            Keep track of your possessions, find service providers, and shop for groceries all in
                            one place.
                        </p>
                    </motion.div>
                    ...
                    >
                        ...
                        <motion.div
                            ...
                            variants={itemVariants}
                        >
                            {Array.from({length: maxIndex + 1}).map((_, index) => (<motion.button
                                key={index}
                                onClick={() => handleDotClick(index)}
                                className={`h-2 rounded-full focus:outline-none ${currentIndex === index ? 'w-6 bg-green-800' : 'w-2 bg-gray-300'}`}
            ...
            >
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <motion.div variants={itemVariants} className="text-center mb-16">
                        <h2 className="text-xl font-semibold text-white tracking-wide uppercase">Our
                            Categories</h2>
                        <p className="mt-1 text-3xl font-extrabold text-gray-900 sm:text-4xl">
                    ...
                    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
                        {[{
                            ...
                            title: "Maintaince Services",
                            description: "House and Appliance Maintainence Services",
                        ...
                        >
                            ...
                            <div className="absolute bottom-0 left-0 items-start text-start p-6">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="lg:grid lg:grid-cols-2 lg:gap-8 items-center">
                        <motion.div variants={slideInFromLeft}>
                            ...
                            <div className="mt-6">
                                {["Vetted and qualified service providers", "Online booking and scheduling", "Service history tracking", "Verified reviews and ratings"].map((item, index) => (
                                    <motion.div
                                        key={index}
                                    ...
                                    >
                                        <svg className="h-5 w-5 text-green-800" fill="currentColor"
                                             viewBox="0 0 20 20">
                            ...
                            >
                                <a href="/user-services" className="text-base font-medium text-green-800 hover:text-green-700">
